...
N = 2^n;
K = 2^(n - 1) + crc_length;
ebno_vec = [2.5]; %row vec, you can write it like [1 1.5 2 2.5 3] 
...
[bler, ber] = simulation(N, K, design_epsilon, max_runs, max_err, resolution,  ebno_vec, list_vec, gen, det, crc_length);
